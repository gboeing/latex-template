...
% - use \enquote{} for quote marks and \textit{} for italics
% - use \citet[][]{} and \citep[][]{} for citations
% - use -- for en-dash and --- for em-dash
% - avoid system fonts, instead use texlive-provided ebgaramond/tgheros font packages
...
You can use parenthetical citations \citep{boeing_off_2021} or textual citations, such as to \citet{boarnet_travel_2001}. You can also usually use end notes\endnote{This is an example end note.} as needed but ideally rarely.
...
Analysis subsection: describe your analyses with enough detail that an expert could replicate them. You can provide equations for precision, such as Equation~\ref{eq:pop_density}.
...
Present the details of your first finding here. Add figures and tables as needed. For example, see Figure~\ref{fig:world_map}.
...
Present the details of your second finding here. Add figures and tables as needed. For example, see Table~\ref{tab:my_table}.
...
Discussion: answer your question, advance your argument, and demonstrate significance. Return to research question and interpret (don't repeat) your findings as evidence for/against it. Tell a story: link your findings together to persuasively advance your argument. Significance: discuss specific implications for research and practice (\enquote{so what}). Acknowledge study's limitations and alternative interpretations of your evidence: what opportunities are there for future research?
