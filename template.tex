...
\documentclass[11pt,twocolumn]{article} % document style
...
% make title and abstract full-page single-column
\twocolumn[
\maketitle
...
\vspace{1cm}
\end{onecolabstract}]
\saythanks % typeset any footnotes arising in the above block
